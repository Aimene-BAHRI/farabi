...
class FactureForm(forms.ModelForm):
	...
	description = forms.CharField(  label="Déscription",
...
class Cours_particulierForm(forms.ModelForm):
	...
	nom_etudiant = forms.CharField(label = "le nom de l'élève",
		widget=forms.TextInput(attrs={'class' : "form-control"}))

	prenom_etudiant = forms.CharField(label = "le prenom de l'élève",
		widget=forms.TextInput(attrs={'class' : "form-control"}))
