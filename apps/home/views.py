...
def export_pdf(request, pk):
    if request.user.is_superuser:
        ...
        try:
            facture = Abonement.objects.get(pk = pk, operateur = request.user.parant)
            return render_to_pdf_response(request,'home/renderdetail.html', {'invoice':facture,'today':today})
    ...
    if request.method == 'POST':
        ...
        if abonement_form.is_valid() :
            ...
            if abonement_object.reste_a_paier == 0:
                ...
                if abonement_object.operateur.subscribed_plan == "mensuel":
                ...
                elif abonement_object.operateur.subscribed_plan == "trimestriel":
                ...
                elif abonement_object.operateur.subscribed_plan == "annuel":
