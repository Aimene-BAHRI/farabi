...
class StudyLevel(models.Model):
	...
	DEVISION_CHOICES = (
		...
		("Math technique(mécanique)" , "Math technique(mécanique)"),
		("Math technique(électricité)" , "Math technique(électricité)"),
		("Math technique(génie civil)" , "Math technique(génie civil)"),
	...
	level = models.CharField("niveau d'étude scolaire",max_length=20, choices=NIVEAU_CHOICES, default="prescolaire")
	classe = models.CharField("classe scolaire",max_length=20, choices=Classe_CHOICES, null=True, blank = True)
	devision = models.CharField("Division scolaire",max_length=50, choices=DEVISION_CHOICES, null=True, blank = True)
...
class Student(models.Model):
	...
	student_firstname = models.CharField("nom de l'élève", max_length=200)
	student_name = models.CharField("prenom de l'élève", max_length=200)
	date_of_birth = models.DateField("date de naissance de l'élève",default=timezone.now)
	place_of_birth = models.CharField("Lieu de naissance de l'élève", max_length=200)
	...
	student_gender = models.CharField("le sexe de l'élève",max_length=10, choices=GENDER_CHOICES, default="homme")
...
class Cours_particulier(models.Model):
	...
	def __str__(self):
		return "Étudiant {} ,matiere{}".format(self.get_full_name(),self.matiere)
