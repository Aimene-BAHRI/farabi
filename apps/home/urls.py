...
urlpatterns = [
    ...
    # Magazin
    path('magasins/', views.magazins, name="magazins"),
    path('magasins/create', views.create_magazin, name="create_magazin"),
    path('magasins/<pk>', views.magazin, name="magazin"),
    path('magasins/delete/<pk>', views.delete_magazin, name="delete_magazin"),
    ...
    # Abonement
    path('abonnements/', views.abonements, name="abonements"),
    path('abonnements/create', views.create_abonement, name="create_abonement"),
    path('abonnements/<pk>', views.abonement, name="abonement"),
    path('abonnements/delete/<pk>', views.delete_abonement, name="delete_abonement"),
    ...
    path('export_pdf_particular_cours/<pk>', views.export_pdf_particular_cours, name='export_pdf_particular_cours'),
